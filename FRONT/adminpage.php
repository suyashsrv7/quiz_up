...
<head>
	...
	<link rel="stylesheet" type="text/css" href="adminpage1.css">
...
<body class="background" >
       <div class="row">
       	<!--address of icon-->
        <nav><a href=""><i class="fa fa-user-times back"></i></a>Admin<div class="logo"><img src="Qlogo.svg"></div></nav>
      ...
      <div class="box" id="questions">
        ...
        ?>
       	    ...
       	    <div class="col-mid-12 col-12">
       	    	  ...
       	    	  <a href="#user"><div class=" user">User<div class="userNo"><?php echo $num_users; ?></div></div></a>
                     </div>
                     <div class="col-mid-6 col-6 ">
       	    	   <a href="#category"><div class=" category">Category<div class="categoryNo"><?php echo $num_categories ; ?></div></div></a>
                     </div>  
       	    </div>
       	    <div class="col-mid-12 col-12">
                    <div class="col-mid-6 col-6 ">	
       	    	   <a href="#topic"><div class=" topic">Topic<div class="topicNo"> <?php echo $num_topics ; ?></div></div></a>
                     </div>
                     <div class="col-mid-6 col-6 ">
       	    	   <a href="#questions"><div class=" questions">Question<div class="questionsNo"> <?php echo $num_questions; ?></div></div></a>
                     </div>
       	    </div>	
       	    </div>
       </div>
